...
.equ PORTFDIR = 0xF0		; use PortD for input/output from keypad: 
							; PF7-4, output, PF3-0, input.
.equ ROWMASK  = 0x0F		; low four bits are output from the keypad. 
							; This value mask the high 4 bits.
