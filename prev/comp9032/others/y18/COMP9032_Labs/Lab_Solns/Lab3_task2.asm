...
.endmacro
		...
		jmp	Start						; Jump to Start to initialize interrupt
...
RESET:
		...
		ori temp, (1 << INT0)           ; Logical OR register with immediate
...
stop:
		out  PORTC, r21                 ; Output the current pattern
		sbic PIND, 1                    ; Skip next Instruction if Bit 1 in PIND is Cleared
		rjmp stop                       ; rjmp to stop
